...
const moduleChecks = {
  ...
  '/evidence': { page: 'src/app/evidence/page.tsx', markers: ['/api/evidence'] },
  ...
  '/admin/data-hub': { page: 'src/app/admin/data-hub/page.tsx', markers: ['/api/admin/data-hub'] },
...
const apiFiles = [
  ...
  'src/app/api/admin/data-hub/route.ts',
  'src/app/api/admin/data-hub/source/route.ts',
