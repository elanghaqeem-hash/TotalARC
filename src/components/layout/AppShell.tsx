...
const navGroups: NavGroup[] = [
  {
    title: 'KELOLA',
    subtitle: 'Definisikan & tata kelola',
    items: [
      { name: 'Dasbor Utama', href: '/', icon: Activity },
      { name: 'Pendaftaran Institusi', href: '/onboarding', icon: Building2 },
      ...
      { name: 'Semesta Risiko & Heatmap', href: '/risks', icon: AlertTriangle },
      { name: 'Pustaka Kontrol Tunggal', href: '/controls', icon: Shield },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Analitik Cakupan & Kesenjangan ICOFR', href: '/icofr/coverage', icon: BarChart3, badge: 'GAP' },
  ...
  },
  {
    ...
    items: [
      { name: 'Kokpit Kesehatan Kontrol', href: '/health', icon: Activity },
      ...
      { name: 'Peralihan Periode ICOFR', href: '/icofr/roll-forward', icon: Calendar, badge: 'NEW FY' },
      { name: 'Kalender Penjaminan', href: '/calendar', icon: Calendar },
